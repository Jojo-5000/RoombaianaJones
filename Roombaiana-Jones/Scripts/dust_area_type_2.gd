...
@export var dust_color : Color = Color(1, 1, 0)  # The color of the dust (used to visualize the dust)
@export var dust_type : String = "type2"  # Add a dust type to differentiate between the two types
